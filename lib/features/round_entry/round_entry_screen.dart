...
import 'free_round_entry_view.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return sessionAsync.when(
      ...
      data: (session) {
        ...
        // Free-score sessions use a wholly separate entry form; the proven bid
        // form below is never reached for them.
        if (session.settings.isFreeScore) {
          return FreeRoundEntryView(session: session, existingRound: round);
        }
